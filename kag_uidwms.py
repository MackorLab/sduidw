...
current_dir = os.getcwd()  # Получить текущую директорию
folder_path17 = os.path.join(current_dir, "extensions", "sd-webui-facefusion")  # Создать путь к новой папке
os.makedirs(folder_path17, exist_ok=True)  # Создать папку
repo_url = "https://github.com/diffus-me/sd-webui-facefusion.git"
